...
def build_parser():
    ...
    p.add_argument("--xi-0", type=float, default=1.0)
    p.add_argument("--nu", type=float, default=1.0)
    p.add_argument("--clover-coeff-t", type=float, default=0.0)
    p.add_argument("--clover-coeff-r", type=float, default=1.0)
    p.add_argument("--t-boundary", type=int, choices=[1, -1], default=1,
    ...
    p.add_argument("--stout-nstep", type=int, default=0, help="0 disables smearing")
    p.add_argument("--stout-rho", type=float, default=0.1)
